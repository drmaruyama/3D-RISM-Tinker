...
c
c
      subroutine mdstat3d (istep,dt,etot,epot,e3d,ekin,temp,pres)
      implicit none
      include 'sizes.i'
      include 'atoms.i'
      include 'bath.i'
...
c
  ...
  140       format (' Deformation',9x,f15.3,' Sqr Angs')
      ...
      write(*,'(f10.3,5f14.4)') pico, etot, epot, e3d, ekin, temp
      write(10,'(f10.3,5f14.4)') pico, etot, epot, e3d, ekin, temp
      return
      end
